...
import com.ssa.R;
import com.ssa.adapters.SchoolsAdapter;
...
public class SchoolsFragment extends Fragment implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, ResultCallback<LocationSettingsResult> {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        rvSchools = (RecyclerView) view.findViewById(R.id.rv_schools);
        tvAddSchool = (TextView) view.findViewById(R.id.tv_add_school);
        ...
        tvAddSchool.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Fragment fragment = new AddSchoolFragment();
                FragmentManager fragmentManager = getActivity().getSupportFragmentManager();

                FragmentTransaction transaction = fragmentManager.beginTransaction();
                transaction.replace(R.id.container, fragment, "Add School");
                transaction.addToBackStack("Add School");
                transaction.commit();
            }
        });
            ...
            public void onResponse(Call<SchoolModel> call, retrofit2.Response<SchoolModel> response) {
                if (response.body() != null) {
                    ...
                    if (response.body() instanceof SchoolModel) {
                        ...
                        if (schoolModel != null) {
                            ArrayList<SchoolModel.Schools> arrSchools = schoolModel.getArrSchools();

                            if (arrSchools != null && arrSchools.size() > 0) {
                                schoolsAdapter = new SchoolsAdapter(getActivity(), arrSchools);
                                rvSchools.setAdapter(schoolsAdapter);
                                rvSchools.setLayoutManager(new LinearLayoutManager(getActivity()));
